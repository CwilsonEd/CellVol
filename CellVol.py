...
if running_from_mercury == True:
   ...
   # Assign modules for the Mercury calculation #
    ...
    def run_report():
        ...
        # Open a txt file labelled by ref code to write your results to. This will write to a 'CellVol_Output' folder on your C-drive. #
        ...
        filepath = r'c:/CellVol_Output'
    	
        if not os.path.exists(filepath):
            os.makedirs(filepath)
    	
        f = open('c:/CellVol_Output/%s.txt' % entry_id, 'w')
